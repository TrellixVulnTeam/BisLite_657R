...
$nav-link-disabled-color:           #000 !default;
...
$navbar-light-toggler-icon-bg:      url("data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 30 30'><path stroke='#{$primary}' stroke-linecap='round' stroke-miterlimit='10' stroke-width='2' d='M4 7h22M4 15h22M4 23h22'/></svg>") !default;
...
$dropdown-color:                    $primary !default;
...
$carousel-indicator-width:           15px !default;
$carousel-indicator-height:          15px !default;
$carousel-indicator-hit-area-height: 10px !default;
$carousel-indicator-spacer:          10px !default;
$carousel-indicator-border-radius:   50% !default;
